...
import { useExceptionLogger } from '@/composables/useExceptionLogger'
...
describe('useExceptionLogger', () => {
  ...
  it('should throw an error if ExceptionLogger is not provided', () => {
    ...
    expect(() => useExceptionLogger()).toThrowError('ExceptionLogger not provided') // Verifica se o erro é lançado corretamente
  })
})
